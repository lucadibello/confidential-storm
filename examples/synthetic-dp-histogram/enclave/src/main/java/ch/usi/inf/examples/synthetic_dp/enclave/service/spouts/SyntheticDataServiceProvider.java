...
public final class SyntheticDataServiceProvider
    implements SyntheticDataService
{

    private final EnclaveLogger log = EnclaveLoggerFactory.getLogger(
        SyntheticDataServiceProvider.class
    );
    ...
    @Override
    public SyntheticEncryptedRecord encryptRecord(
        String key,
        String count,
        String userId
